...
//     console.log(
//       `📍 [Background] App state check - foregroundApiEnabled=${foregroundApiEnabled}, isAppInForeground=${inForeground}`,
//     );
//     if (inForeground) {
//       console.log(
...
//     }
//     console.log(
//       "📍 [Background] App is in background - proceeding with location update",
//     );
...
//     if (!isRegistered) {
//       console.log(
//         "📍 [Background] Registering location task for first time...",
//       );
...
//       });
//       console.log(
//         "✅ [Background] Location task registered successfully - will run when app is backgrounded",
//       );
//     } else {
